    ...
    <div className="h-14 flex items-center justify-between px-4 glass-panel bg-carbon-900/60">
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <button onClick={onCopy} className="text-xs text-emerald-300 hover:text-emerald-200 px-2 py-1 rounded border border-white/10 hover:bg-white/5">Copy</button>
        </div>
      ...
      <div className="flex items-center gap-3">
        ...
        {rightActions}
        <button onClick={onLeave} className="px-3 py-1.5 text-xs rounded border border-white/10 bg-white/5 hover:bg-white/10 text-gray-100">Leave</button>
      </div>
    </div>
  )
}
